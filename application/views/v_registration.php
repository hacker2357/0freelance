            ...
            <div class="projects_list">
           		<div class="project" style="width:280px; margin:0 auto; padding:20px 20px 30px;">
                	<div class="login_title">Регистрация</div>
                        <form action="<?=URL::base().Route::get('default')->uri(array('controller' => 'registration'));?>" method="POST">
							...
							<div class="login_field">
								<div class="button_con">
									<input type="submit" class="login_button" id="login_button" name="login_button" value="Зарегистрироваться" />
								</div>
							</div>
			</form>
                </div>
