...
class Controller_Uvedomlenya extends Controller_Base
{
	...
	public function action_getpage()
	{
		...
		$this->template->page_title = 'Настройки - Уведомления';
		
		$content = View::factory('v_uvedomlenya')->set('sidebar', array(Request::factory('widgets/sidebar')->execute()))
